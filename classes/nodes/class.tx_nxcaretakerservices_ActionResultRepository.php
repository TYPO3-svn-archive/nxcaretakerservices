 ...
 *
 * $Id: class.tx_caretaker_TestResultRepository.php 27092 2009-11-27 22:30:42Z martoro $
 */
 ...
 */
class tx_nxcaretakerservices_ActionResultRepository {
	...
	public function getInstance(){
		if (!self::$instance) {
			self::$instance = new tx_nxcaretakerservices_ActionResultRepository();
		}
	 ...
	 */
	public function getLatestByNode( tx_caretaker_ActionNode $testNode ){
	 ...
	 * @return integer
	 */
	public function getResultNumberByNode( tx_caretaker_ActionNode $testNode ){
		$testUID     = $testNode->getUid();
		$instanceUID = $testNode->getInstance()->getUid();
	 ...
	 */
	public function getResultRangeByNodeAndOffset( tx_caretaker_ActionNode $testNode, $offset=0, $limit=10){
	 ...
	 * @return tx_caretaker_testResultRange
	 */
	public function getRangeByNode ( tx_caretaker_ActionNode $testNode, $start_timestamp, $stop_timestamp, $graph = true){
	 ...
	 */
	function saveTestResultForNode(tx_caretaker_ActionNode $test, $testResult){
