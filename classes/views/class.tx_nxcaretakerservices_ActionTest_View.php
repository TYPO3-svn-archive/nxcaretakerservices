...
class tx_nxcaretakerservices_ActionTest_View extends t3lib_SCbase {
	...
	function getNodeActions($node) {
		...
		if (!$hidden)              $actions .= '&nbsp;<a href="index.php?&id='.$_GET['id'].'&SET[function]='.$this->MOD_SETTINGS["function"].';&SET[action]=delete" ><img src="../res/icons/pencil.png" title="delete INSTALL_TOOL"/></a>';
